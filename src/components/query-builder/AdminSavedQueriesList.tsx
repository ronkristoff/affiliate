...
interface AdminSavedQueriesListProps {
...
export function AdminSavedQueriesList({ onLoadQuery }: AdminSavedQueriesListProps) {
  const queries = useQuery(api.admin.queryBuilder.listSavedQueries);
  ...
  const handleDelete = async (id: string, name: string) => {
    setDeletingId(id);
    try {
      await deleteMutation({ queryId: id as any });
