...
export function PlatformEmailTemplateEditor({ templateType, onClose }: PlatformEmailTemplateEditorProps) {
  const template = useQuery(api.platformTemplates.getPlatformEmailTemplate, {
    templateType,
  });
  const upsertTemplate = useMutation(api.platformTemplates.upsertPlatformEmailTemplate);
  const resetTemplate = useMutation(api.platformTemplates.resetPlatformEmailTemplate);
  ...
  useEffect(() => {
    ...
    for (const required of template.requiredVariables) {
      if (!subjectVars.includes(required) && !bodyVars.includes(required)) {
      ...
      <div className="px-8 py-6 max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-[var(--text-primary)]">{template.label}</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-4">
            <Card className="border-[var(--border-light)] shadow-sm">
              <CardHeader className="pb-3">
                ...
                <CardDescription>The email subject line. Use variables to personalize.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-2">
                  <Input
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>HTML content of the email. Use variables to personalize.</CardDescription>
                  </div>
          ...
          <div className="space-y-4">
            <Card className="border-[var(--border-light)] shadow-sm sticky top-8">
              <CardHeader className="pb-3">
            ...
            {template.status === "customized" && (
              <Card className="border-[var(--border-light)] shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm text-[var(--text-muted)]">Default Template</CardTitle>
                </CardHeader>
                <CardContent>
