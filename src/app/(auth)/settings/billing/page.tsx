...
export default function BillingSettingsPage() {
  ...
  const handleUpgradeSubmit = async () => {
    ...
    try {
      ...
      reportClientError({ source: "BillingSettingsPage", message: getErrorMessage(error, "Upgrade failed") });
    } finally {
  ...
  const handlePayNow = async () => {
    ...
    try {
      ...
      reportClientError({ source: "BillingSettingsPage", message: getErrorMessage(error, "Reactivation failed") });
    } finally {
  ...
  const handleDowngradeConfirmationConfirm = async () => {
    ...
    try {
      ...
      reportClientError({ source: "BillingSettingsPage", message: getErrorMessage(error, "Downgrade failed") });
    } finally {
  ...
  const handleCancellationConfirmationConfirm = async () => {
    ...
    try {
      ...
      reportClientError({ source: "BillingSettingsPage", message: getErrorMessage(error, "Cancellation failed") });
    } finally {
