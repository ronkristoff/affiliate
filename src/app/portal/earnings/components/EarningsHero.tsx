    ...
    >
      <div className="mb-2">
        ...
        <h2 className="text-3xl font-black">
          {formatAmount(earningsSummary.totalEarnings)}
        </h2>
      ...
      <div className="grid grid-cols-3 gap-4 pt-4">
        ...
        <div className="text-center">
          ...
          <p className="text-xl font-bold">{formatAmount(earningsSummary.paidOut)}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-xl font-bold">{formatAmount(earningsSummary.confirmedBalance)}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-xl font-bold">{formatAmount(earningsSummary.pendingBalance)}</p>
