...
export function LinkPerformanceCard({ linkData }: LinkPerformanceCardProps) {
          ...
          {dailyClicks.map((day, index) => {
            ...
            return (
              <div key={day.date} className="flex-1 flex flex-col items-center">
                <div
                  className={`w-full rounded-t transition-all ${day.isToday ? 'bg-[var(--portal-primary)]' : 'bg-[#9CA3AF]'}`}
                  style={{
                    height: `${height}%`,
                  }}
                />
