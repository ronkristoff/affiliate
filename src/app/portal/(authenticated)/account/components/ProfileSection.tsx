...
export function ProfileSection({ name, email, referralCode, status }: ProfileSectionProps) {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          <div
            className="h-12 w-12 rounded-full flex items-center justify-center text-white font-bold text-lg bg-[var(--portal-primary)]"
          >
