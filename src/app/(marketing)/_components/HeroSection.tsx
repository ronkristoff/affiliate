...
function ReducedMotionHero({ trialDays }: { trialDays: number }) {
  return (
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 text-left">
            ...
            <p className="text-sm text-[#6b7280] tracking-wide">
              {trialDays} days free · No credit card required · Cancel anytime
            </p>
          </div>
...
export function HeroSection() {
  ...
  if (prefersReducedMotion) {
    return <ReducedMotionHero trialDays={trialDays} />;
  }
