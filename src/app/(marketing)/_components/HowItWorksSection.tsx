...
function StepCard({ step, index, isVisible }: { step: typeof steps[0]; index: number; isVisible: boolean }) {
  return (
    ...
    >
      {/* Step Card - elevated */}
      <div className="bg-[#fafafa] rounded-3xl border-2 border-[#e5e7eb] p-10 relative z-10 hover:border-[#1c2260]/30 hover:shadow-2xl transition-all duration-500 group">
        {/* Number badge */}
        <div 
          className="absolute -top-5 left-10 w-12 h-12 rounded-2xl bg-gradient-to-br from-[#1c2260] to-[#1fb5a5] text-white flex items-center justify-center font-black text-xl shadow-lg shadow-[#1c2260]/30 transition-transform duration-300 group-hover:scale-110"
          style={{
            boxShadow: isVisible 
              ? '0 10px 25px -5px rgba(28, 34, 96, 0.3)' 
              : '0 4px 10px -2px rgba(28, 34, 96, 0.2)',
          }}
        >
          {step.number}
        </div>
        ...
        <h3 className="font-bold text-2xl text-[#333333] mb-3 group-hover:text-[#1c2260] transition-colors duration-300">
          {step.title}
        </h3>
        ...
        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#1c2260]/10 text-[#1c2260] text-sm font-bold group-hover:bg-[#1c2260]/20 transition-colors duration-300">
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-[0.02] pointer-events-none" style={{
        backgroundImage: `radial-gradient(circle at 2px 2px, #1c2260 1px, transparent 0)`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#1c2260] mb-6 leading-[1.1]">
            ...
            <span className="text-[#0e1333]">three steps</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-[16.67%] right-[16.67%] h-1 overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#1c2260]/20 via-[#1c2260] to-[#1c2260]/20 rounded-full"
              style={{
                width: `${lineWidth}%`,
